---
question: 不使用 MRTK 可以使用 XR_MSFT_scene_understanding 嗎？我從 scene understanding 拿到的資料格式長什麼樣（給我一些範例）？比如說我可以做到，只使用 scene understanding 就在桌子上放置一個我已有的 3D 模型之類的嗎？
---
